...
for x in ticker:
    ...
    data = pdr.get_data_yahoo(x, interval = "1h", start="2019-05-05", end="2019-11-06")
    ...
    if AB<0 and BC>0 and CD<0 and DE>0 and EF<0:
        if A>B and A>D and A>C and A>E and A>F and B < C and B < E and B < F and B < D and C > E and C < A and C > B and C > D and D < B and D < A and D < C and D < E and D < F and E > F and E > D and E > B and F > D and F < E:
    ...
    if AB<0 and BC>0 and CD<0 and DE>0 and EF<0:
        if A > B and A > D and A < C and A < E and B > D and B < A and B < C and B < E and B < F and C > A and C < E and C > B and C > D and D < B and D < A and D < C and D < E and D < F and E > A and E > C and E > F and E > B and F < E and F > A and F > B and F > D:
